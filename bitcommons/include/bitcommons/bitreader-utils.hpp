...
template <>
struct integral_by_size<1> : id_t<uint8_t>
{
};
template <>
struct integral_by_size<2> : id_t<uint16_t>
{
};
template <>
struct integral_by_size<4> : id_t<uint32_t>
{
};
template <>
struct integral_by_size<8> : id_t<uint64_t>
{
};
...
//--------------------------------------------------------------------------
template <>
struct bit_read_helper<float> : floating_point_bit_read_helper<float>
{
};
template <>
struct bit_read_helper<double> : floating_point_bit_read_helper<double>
{
};
template <>
struct bit_read_helper<long double> : floating_point_bit_read_helper<long double>
{
};
